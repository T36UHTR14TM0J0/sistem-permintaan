            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('Barang/barang_simpan') ?>" method="post" enctype="multipart/form-data" id="form_barang">
...
$(document).ready(function() {
    ...
    $('#form_barang').submit(function(e) {
        ...
        if ($('#keterangan').val().trim() === '') {
            $('#error_keterangan').text('Keterangan harus diisi').css('color', 'red');
            isValid = false;
        }
